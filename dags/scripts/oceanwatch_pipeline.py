...
with DAG(
    ...
    description="OceanWatch: Ingest → dbt → Ops → ML → Phase11 → Phase12 → Alerts → WIO → Digest",
    schedule_interval="@daily",
    start_date=datetime(2026, 1, 1),
    catchup=False,
    tags=["oceanwatch", "ml", "phase11", "phase12"],
) as dag:
    ...
    phase12 >> enrich_alerts

    [enrich_alerts, ml_port_risk, ml_bloom, ml_habitat, ml_sst, phase12] >> compute_wio

...
st.markdown(
    """
### What OceanWatch is
Kenya-first **Western Indian Ocean** intelligence: ocean conditions, port risk, fishing effort (GFW),
vessel activity, ML forecasts/anomalies, and the **WIO-OII** index.
